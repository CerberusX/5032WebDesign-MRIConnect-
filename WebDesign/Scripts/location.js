...
*/
const TOKEN = "pk.eyJ1IjoieXVoYW5naHVhbmciLCJhIjoiY2xsOTMxanFrMGFkMDNkcDZnZGlxbGs1YyJ9.3e4L6wEa7ttdXRazmTGwZA";
var locations = [];
...
map.on('click', function(e) {
    ...
    console.log("Latitude: " + selectedLatitude + ", Longitude: " + selectedLongitude);  // 这行是新增的
